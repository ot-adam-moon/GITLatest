...
| `grunt svcinstall` | will start all Windows services and webs |
| `grunt webstart` | will start all Windows services and webs |
| `grunt svcstart` | will start all Windows services and webs |
